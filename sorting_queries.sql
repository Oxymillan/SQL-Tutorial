...
-- Selecting students with student_id of less than 3 and that doesn't have the name Jack
SELECT *
FROM student
WHERE student_id < 3 AND name <> 'Jack';

--We are selecting from table only the students that have the names 'Claire', 'Kate' or 'Mike'
SELECT *
FROM student
